...
if("TRUE" STREQUAL "TRUE")
  set(search_SOURCE_PREFIX /home/agilex/bot_temp/ws/src/search)
  set(search_DEVEL_PREFIX /home/agilex/bot_temp/ws/devel)
  set(search_INSTALL_PREFIX "")
  set(search_PREFIX ${search_DEVEL_PREFIX})
else()
  set(search_SOURCE_PREFIX "")
  set(search_DEVEL_PREFIX "")
  set(search_INSTALL_PREFIX /home/agilex/bot_temp/ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'search' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/agilex/bot_temp/ws/src/search/${idir}'.  ${_report}")
    endif()
